...
class Reqproduct_model extends CI_Model {
    ...
    //reqproduct table tryyyyy
    // public function reqproductList()
    // {
    //     $this->db->select('*');
    //     $query = $this->db->from('reqproductrecord');
    //     $this->db->join('productrecord', 'productrecord.productId = reqproductrecord.productId;');
    //     return $query->result();
    // }
